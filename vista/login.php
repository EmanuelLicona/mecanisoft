      ...
      <div class="card-body my-3">
        <form id="login-form" action="javascript:;" method="post">
          <div class="input-group mb-4">
            <input type="text" class="form-control" placeholder="Username" id="usuario" value="bAlvarez01" autocomplete="off" maxlength="40">
          ...
          <div class="input-group mb-2">
            <input type="password" class="form-control" placeholder="Password" id="password" value="brayan" maxlength="250">
            <div class="input-group-append">
              <div class="input-group-text">
